...
test('GitHub Pages is a read-only discovery surface with an explicit DSH boundary', async () => {
  ...
  assert.match(html, /name="keywords" content="DSH, dsh-plugin, DeepSeek Harness, Harness Flow, Harness Flow Hub, Agent Stack, plugin registry"/)
  assert.match(html, /开发者搜索别名：DSH Flow Hub · dsh-plugin · DeepSeek Harness/)
